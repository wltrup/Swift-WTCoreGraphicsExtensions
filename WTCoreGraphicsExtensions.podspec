Pod::Spec.new do |s|
  ...
  s.dependency 'WTUIColorExtensions'
    ...
    s.subspec 'WTBinaryFloatingPointExtensions' do |sa|
        sa.source       = { :git => 'https://github.com/wltrup/Swift-WTBinaryFloatingPointExtensions.git' }
    end

    s.subspec 'WTUIColorExtensions' do |sb|
        sb.source       = { :git => 'https://github.com/wltrup/iOS-Swift-WTUIColorExtensions.git' }
    end
